...
import { call, put, all, apply, fork, takeEvery } from 'typed-redux-saga'
...
// export function subscribe(socket) {
//   return eventChannel<
//   | ActionFromMapping<CertificatesActions> |
//   ReturnType<typeof PB.actions.responseGetPublicChannels>
//   >(emit => {
//     socket.on(socketsActions.MESSAGE, payload => {
//       emit(PB.actions.loadMessage(payload))
//     })
//     socket.on(socketsActions.RESPONSE_FETCH_ALL_MESSAGES, payload => {
//       emit(PB.actions.responseLoadAllMessages(payload))
//     })
//     socket.on(socketsActions.RESPONSE_GET_PUBLIC_CHANNELS, payload => {
//       console.log('got response')
//       emit(PB.actions.responseGetPublicChannels(payload))
//     })
//     socket.on(socketsActions.SEND_IDS, payload => {
//       emit(PB.actions.sendIds(payload))
//     })
//     socket.on(socketsActions.RESPONSE_GET_CERTIFICATE, payload => {
//       emit(certificatesActions.setOwnCertificate(payload))
//     })
